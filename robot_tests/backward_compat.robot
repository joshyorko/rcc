...
Goal: Verify version is correct
    [Documentation]    Check that the RCC version is correct for zstd support
    Step    build/rcc version --controller citests
    Use STDOUT
    Must Have    v19
    Comment    Version v19+ includes zstd compression support
