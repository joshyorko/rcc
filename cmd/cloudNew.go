...
var newCloudCmd = &cobra.Command{
	Use:   "new",
	Short: fmt.Sprintf("Create a new robot into %s Control Room.", common.Product.Name()),
	Long:  fmt.Sprintf("Create a new robot into %s Control Room.", common.Product.Name()),
