...
// StyledLogBuffer wraps LogBuffer to provide styled rendering methods for interactive package
...
// Render returns a formatted string of the N most recent logs using interactive.Styles
...
// FormatStats returns a formatted stats summary using interactive.Styles
